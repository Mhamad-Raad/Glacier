...
const AboutUsSection = () => {
  return (
    ...
    >
      ...
      <h2 className="xl:text-[78px] text-center lg:text-[64px] text-white font-extrabold lg:tracking-[3.2px] lg:mt-[34px] md:text-[36px] md:tracking-[1.8px] md:mt-[19px] sm:text-[24px] sm:tracking-[1.2px] sm:mt-[5px]">
        KNOW WHO WE ARE
      </h2>
