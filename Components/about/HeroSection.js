...
const HeroSection = () => {
  return (
    <section className="xl:px-[111px] md:px-[60px] sm:pl-[24px] md:pr-[25px] sm:pr-[10px] mt-[180px] relative flex md:flex-row sm:flex-col items-center justify-between sm:gap-[75px]">
      ...
      <div className="xl:w-[524px] xl:h-[600px] lg:w-[408px] lg:h-[453px] relative bg-gradient-to-br from-[#1588ff] to-[#cfeeff] md:rounded-tr-[175px] md:rounded-bl-[175px] md:mr-[31px] md:h-[400px] md:w-[350px] sm:w-[150px] sm:h-[160px] sm:rounded-tr-[60px] sm:rounded-bl-[60px] sm:mr-[20px]">
        <Image
          src={Hero}
