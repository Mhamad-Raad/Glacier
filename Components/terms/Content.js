...
import PDFIcon from '@/assets/terms/PDFIcon';

import { Paragraph1, Paragraph2 } from '@/data/terms/ParagraphData';
        ...
        <div className="hide-desktop flex flex-col gap-[24px]">
          ...
          <div className="flex items-center gap-[23px]">
            ...
            <div className="flex flex-col gap-[6px]">
              ...
              <h3 className="tracking-[1.2px] leading-[25px] text-[24px] text-[#2b3c40] font-[600]">Terms of Service</h3>
            </div>
          </div>
          <p className="xl:text-[22px] lg:text-[18px] font-[500] tracking-[0.9px] mt-[7px] md:text-[14px]">
            Last Updated: 26/8/2023
